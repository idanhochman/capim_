...
Sources:
  ...
  word_size_bytes = 1 for INT8 quantization (assumed for mobile deployment).
"""
...
class ModelConfig:
    ...
    word_size_bytes: int    # bytes per parameter: 1=INT8, 2=FP16
    ...
    def weight_bytes(self) -> float:
        ...
        return total_params * self.word_size_bytes
    ...
    def kv_cache_bytes(self, seq_len: int, batch_size: int = 1) -> float:
        ...
        return self.n_layers * per_layer * self.word_size_bytes
    ...
    def flops_per_token(self, seq_len: int) -> float:
        ...
        linear_flops = 2 * self.weight_bytes() / self.word_size_bytes
...
QWEN2_5_7B = ModelConfig(
    ...
    vocab_size=152064,
    word_size_bytes=1,   # INT8 quantization
)
